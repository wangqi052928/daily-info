...
SYS_CONFIG = {
    ...
    # 测试号appID，非必填
    # 需要测试号发送时必填
    "appid": "wx1b6a4e10b5b0dba1",

    # 测试号appsecret，非必填
    # 需要测试号发送时必填
    "appsecret": "437eb967dd6ae3edd5edb10595825897",

    # 测试号后台用户微信号，非必填
    # 需要测试号发送时必填
    # 多用户以&&分割
    # 例如：abc123&&def456
    "userid": "437eb967dd6ae3edd5edb10595825897",

    # 测试号模板ID，非必填
    # 需要测试号发送时必填
    "templateid": "4av7HF4OGMzCnDccDH59eLl8SD4cPsLBu21mJX19CPM",
    ...
    # 和风天气Key，非必填
    # 需要天气信息时必填
    "qweather": "055d3b867c4f4b4a85346931544e6312",
    ...
    # 天行数据APIKEY，非必填
    # 需要彩虹屁功能时必填
    "tian": "51ed8216a5b6bebbc262bc71e76080a0",
